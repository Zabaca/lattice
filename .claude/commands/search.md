...
Ask the user: **"Does this existing documentation cover your question?"**
...
| "local-knowledge-graph naming" | `local-knowledge-graph/` | `naming.md` |
...
| Document | Description |
|----------|-------------|
| [Existing Doc](./existing.md) | Previous research |
| [New Research](./{new-filename}.md) | Brief description |  ← ADD THIS ROW
```
...
- Cross-link to related documentation topics when relevant
